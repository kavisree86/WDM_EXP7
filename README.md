...
### Output:
<img width="629" alt="image" src="https://github.com/user-attachments/assets/bfe75852-2925-406c-a67c-9ccd95f12a9b">


### Result:
Thus ,Link Analysis using HITS Algorithm in python ia successfully implemented
